...
{
    public partial class s16878Context : DbContext
    {
        public s16878Context()
        {
        }

        public s16878Context(DbContextOptions<s16878Context> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<EfDbService> Student { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=db-mssql;Initial Catalog=s16878;Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EfDbService>(entity =>
            {
